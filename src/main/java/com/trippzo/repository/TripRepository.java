...
public interface TripRepository extends JpaRepository<Trip, Long> {
    ...
    List<Trip> findByOriginContainingIgnoreCaseAndDepartureDateTimeBetween(String origin, LocalDateTime start,
            LocalDateTime end);

    List<Trip> findByDestinationContainingIgnoreCaseAndDepartureDateTimeBetween(String destination, LocalDateTime start,
            LocalDateTime end);
